...
class mobile extends rcube_plugin
{
    ...
    function init()
    {
        ...
        $this->add_button(array(
            ...
            'class'	=> 'button-switch_desktop ui-link ui-btn ui-shadow ui-corner-all ui-icon-home ui-btn-icon-left',
            'classsel' => 'button-switch_desktop button-selected ui-link ui-btn ui-shadow ui-corner-all ui-icon-home ui-btn-icon-left',
        ...
        if ($this->api->output->type == 'html') {
            if ($this->isMobile()
                ...
                $this->rc->config->set('skin', '_mobile');
                $this->rc->output->set_env('skin', $skin);
                $this->rc->output->set_skin($skin);
            }
        }
    ...
    public function config_get($args)
    {
        switch ($args['name']) {
            ...
            case 'list_cols':
                $args['result'] = array('status', 'from', 'date', 'subject', 'attachment', 'flag', 'labels');
                break;
            case 'dont_override':
